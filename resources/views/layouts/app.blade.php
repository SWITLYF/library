...
<div class="container">
    ...
    <div class="row align-items-center">
        ...
        <div class="col-md-6">
            <div class="logo">
                <a href="#"><img src="{{ asset('images/library.png') }}" class="img-fluid" style="max-width: 150px;"></a>
            </div>
        </div>
        <!-- Username and dropdown on the right -->
        ...
        <div class="col-md-6 text-right">
            {{-- <span class="btn btn-secondary dropdown-toggle">Hi {{ auth()->user()->name }}</span> --}}
            <a class="btn btn-danger" href="{{ route('change_password') }}">Change Password</a>
            <a class="btn btn-danger" href="#" onclick="document.getElementById('logoutForm').submit()">Log Out</a>
...
<!-- /HEADER -->
    ...
    <div id="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <span>School Library Management System</a></span>
                </div>
            </div>
        </div>
    </div>
